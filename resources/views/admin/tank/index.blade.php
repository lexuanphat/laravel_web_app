...
<div class="card">
    <div class="card-body">
        <div class="button-actions">
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modal_create"><i class="mdi mdi-plus-circle"></i> Thêm mới bồn chứa</button>
        </div>
        <table id="table_manage" data-action="{{route('admin.tank.get_data')}}" class="table dt-responsive w-100">
            <thead>
                <tr>
                    <th>
                     ...
                     <th>
                        <div class="text-uppercase align-middle">Mã số bồn</div>
                    </th>
                    <th>
                        <div class="text-uppercase align-middle">Loại bồn</div>
                    </th>
                    <th>
...
<div class="list-modal">
    @include('admin.tank.modals.create')
    @include('admin.tank.modals.edit')
...
@push('js')
    <script>
        ...
        const elements = {
            ...
            action_update: @json(route('admin.tank.update', ['id' => ':id'])),
            action_delete: @json(route('admin.tank.delete', ['id' => ':id'])),
        }
