...
<div class="card">
    <div class="card-body">
        <div class="button-actions">
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modal_create"><i class="mdi mdi-plus-circle"></i> Thêm mới thùng</button>
        </div>
        <table id="table_manage" data-action="{{route('admin.vat.get_data')}}" class="table dt-responsive w-100">
            <thead>
                <tr>
                    <th>
                     ...
                     <th>
                        <div class="text-uppercase align-middle">Mã số thùng</div>
                    </th>
                     <th>
                        <div class="text-uppercase align-middle">TT cá tốt</div>
                    </th>
                     <th>
                        <div class="text-uppercase align-middle">TT thùng</div>
                    </th>
                    <th>
...
<div class="list-modal">
    @include('admin.vat.modals.create')
    @include('admin.vat.modals.edit')
...
@push('js')
    <script>
        ...
        const elements = {
            ...
            action_update: @json(route('admin.vat.update', ['id' => ':id'])),
            action_delete: @json(route('admin.vat.delete', ['id' => ':id'])),
        }
        ...
        function createStore(url, form, button_click){
            ...
            formData.append("max_capacity", $("#max_capacity").val().replaceAll('.', ''))
            formData.append("current_capacity", $("#current_capacity").val().replaceAll('.', ''))
        ...
        function updateStore(url, form, button_click){
            let object = {
                ...
                max_capacity: form.find("#max_capacity").val().replaceAll('.', ''),
                current_capacity: form.find("#current_capacity").val().replaceAll('.', ''),
                method: 'PUT',
                status_vat: form.find('#status_vat').val(),
                fish_status: form.find('#fish_status').val(),
            };
        ...
        function renderTable(search){
            elements.table_manage.DataTable({
                ...
                columns: [
                    ...
                    { data: 'fish_status', class: 'align-middle'},
