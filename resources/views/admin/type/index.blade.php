...
<div class="card">
    <div class="card-body">
        <div class="button-actions">
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modal_create"><i class="mdi mdi-plus-circle"></i> Thêm mới</button>
        </div>
        <table id="table_manage" data-action="{{route('admin.type.get_data')}}" class="table dt-responsive w-100">
            <thead>
                <tr>
                    <th>
                     ...
                     <th>
                        <div class="text-uppercase align-middle">Loại chi tiêu</div>
                    </th>
                    <th>
...
<div class="list-modal">
    @include('admin.type.modals.create')
    @include('admin.type.modals.edit')
...
@push('js')
    <script>
        ...
        const elements = {
            ...
            action_update: @json(route('admin.type.update', ['id' => ':id'])),
            action_delete: @json(route('admin.type.delete', ['id' => ':id'])),
        }
        ...
        function updateStore(url, form, button_click){
            let object = {
                ...
                type_report: form.find('#type_report').val(),
        ...
        function renderTable(search){
            elements.table_manage.DataTable({
                ...
                columns: [
                    ...
                    { data: 'type_report', class: 'align-middle'},
