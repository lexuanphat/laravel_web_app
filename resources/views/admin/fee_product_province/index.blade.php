...
<div class="card">
    <div class="card-body">
        <div class="button-actions">
            <button type="button" class="btn btn-primary mb-2" id="btn_show_modal_create" data-bs-toggle="modal" data-bs-target="#modal_action"><i class="mdi mdi-plus-circle"></i> Thêm mới giá khu vực</button>
        </div>
        <table id="table_manage" data-action="{{route('admin.fee_product_province.get_data')}}" class="table dt-responsive w-100">
            <thead>
                <tr>
                    <th>
                    ...
                    <th>
                        <div class="text-uppercase align-middle">Khu vực</div>
                    </th>
                    <th>
...
<div class="list-modal">
    @include('admin.fee_product_province.modals.form')
...
<script>
    ...
    const title = {
        create: "Thêm mới giá khu vực",
        edit: "Chỉnh sửa giá khu vực",
        btn_create: "Thêm mới",
        btn_edit: "Cập nhật",
    };

    const route = {
        create: @json(route('admin.fee_product_province.store')),
        update: @json(route('admin.fee_product_province.update', ['id' => ':id'])),
        delete: @json(route('admin.fee_product_province.delete', ['id' => ':id'])),
        get_data_product: @json(route('admin.fee_product_province.get_data_product')),
    };
    ...
    const elements_modal = {
        ...
        province_id: elements.modal.find('#province_id'),
        ...
        elements.table_manage.DataTable({
            language: {
                ...
                columns: [
                    ...
                    { data: 'product_name', class: 'align-middle all',},
                    { data: 'fee', class: 'align-middle'},
                    { data: 'province_name', name: "action", class: 'align-middle'},
            ...
            success: async function(res){
                if(res.success) {
                    ...
                    $.each(res.data, function(key, value){
                       if(key === 'province_id' || key === 'product_id') {
