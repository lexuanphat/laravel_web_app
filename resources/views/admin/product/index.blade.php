        ...
        <table id="table_manage" data-action="{{route('admin.product.get_data')}}" class="table dt-responsive w-100">
            <thead>
                <tr>
                    ...
                    <th>
                        <div class="text-uppercase align-middle">Danh mục</div>
                    </th>
                    <th>
                        <div class="text-uppercase align-middle">Hình ảnh</div>
                    </th>
                    <th>
        ...
        function renderTableStore(){
            elements.table_manage.DataTable({
                ...
                columns: [
                    ...
                    { data: 'category.name', width: '30%', class: 'align-middle'},
                    { data: 'image_url', width: '30%', class: 'align-middle'},
